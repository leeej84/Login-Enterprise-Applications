// MSEdge Multi-Tab Script version 1.0
// Open a random number of tabs in MSEdge and select a website from a list at random to open
...
public class MSEdge_MultiTab : ScriptBase
{
    ...
    {           
        ...
        while( x != randomTabs ) {       
            //Open a new tab
            MainWindow.FindControl(className : "Button:NewTabButton", title : "New Tab").Click();
            
            //Select the address bar
            MainWindow.FindControl(className : "Edit:OmniboxViewViews", title : "Address and search bar").Click();
			...
			//Allow local content
			MainWindow.FindControl(className : "Button", title : "Allow blocked content", continueOnError = true).Click(); 
